...
>
> **Coding-agent rule:** do not invent, reinterpret, or silently complete rules that are absent, ambiguous, or marked TBD here. For a narrow implementation task, the task prompt may restate the relevant subset of these rules; if that prompt conflicts with this file, report the conflict rather than choosing one.
>
...
Weapon skills function in the same way as Attribute skills. Weapon skills reflect the Fated’s mastery of a group of weapons, such as Swords or Bows. All Weapon Proficiencies are associated with the Body attribute.
...
When a Fated makes a Dice Roll, it always rolls 1d20 Fate Die alongside its Success Dice. Only Fated ever roll the Fate Die; non-Fated characters roll only Success Dice. The number of Success Dice rolled depends on the relevant skill.

## Success Dice (d6)

A Success Die rolls a Success on a 4+ and a Failure on a 1-3. This is known as the Success Threshold, and it can be modified by conditions such as Hope, Wounds, Load, Exhaustion, multiple actions, equipment, and other rules. All Success Threshold modifiers are cumulative: apply every applicable bonus and penalty to determine the final Success Threshold.  
...
The Fate Die is rolled alongside the Success Dice. It doesn’t affect the result of the action, but it reflects the repercussions the action causes.  
...
When rolling an attack, the attacker rolls Success Dice equal to its skill with the weapon.  
For each success, the attacker scores an amount of damage equal to the Weapon’s.  
...
Creating one of the Fated begins with a foundation of baseline competence, where every hero starts with primary attributes at level 2 and all skills and weapon proficiencies at level 1\. From this starting point, you will shape your hero by investing points to improve their natural talents and earned training, a process that directly defines critical secondary attributes like **Defense**, **Endurance**, **Hope**, and **Power**. A central mechanic in this development is the relationship between attributes and skills: while raising a skill is generally straightforward, pushing your training beyond your natural attribute levels becomes significantly more taxing, encouraging a strategic balance between innate ability and specialized practice. For the standard v0.1 character creation rules, Fated use the Separated Points System described below. The Unified Point-Buy System is retained as an alternative, experimental creation method for groups that want greater variation in starting Attributes and Power. Characters may be built from scratch or from a pre-balanced Archetype.
...
* **Skills & Proficiencies:** All 18 core skills and weapon proficiencies start at a default level of **1**.
...
The cost to raise a skill is dynamic and depends on your Attribute investment:

* **Normal Cost:** Raising a skill to a level **equal to or lower** than its associated Attribute costs **1 point** per level.  
* **Specialized Cost:** Raising a skill to a level **higher** than its associated Attribute costs **2 points** per level.  
* **Skill Cap:** A skill level cannot exceed **twice the value** of its associated Attribute.
...
*Note: This archetype represents a 16-point deduction from the 40-point pool, leaving the player with 24 flexible points.*

The Champion is a warrior of high endurance and martial skill, pre-optimized to ensure their combat skills remain inexpensive to level up.

**Archetype Investment (16 Points):**

* **Attribute Increases (10 pts):** \+1 Body (3), \+1 Heart (3).  
* **Skill & Proficiency Package (6 pts):**  
  * **Swords Proficiency:** Level 3 (Costs 2 pts; remains "Normal Cost" due to Body 3).  
  * **Battle:** Level 2 (Costs 1 pt).  
  * **Athletics:** Level 2 (Costs 1 pt).  
  * **Awe:** Level 2 (Costs 1 pt).  
  * **Shields Proficiency:** Level 2 (Costs 1 pt).

**Remaining Flexible Points:** **24** (Can be spent to further increase Attributes for 5 pts or add more Skills for 1–2 pts).
...
* **Efficiency:** Because of the Body 3 and Heart 3 starting values, the player can buy any associated skills up to Level 3 at the **Normal Cost** of 1 point per level.
...
* **Skill Points (14):** These are used to raise skills or weapon proficiencies from their starting level of 1\.

#### **3\. The Skill Point Cost Rule**

The cost to raise a skill is tied directly to its associated Primary Attribute:

* **Normal Cost:** Raising a skill to a level **equal to or lower** than its associated Attribute costs **1 Skill Point** per level.  
* **Specialized Cost:** Raising a skill to a level **higher** than its associated Attribute costs **2 Skill Points** per level.  
* **Skill Cap:** A skill level cannot exceed **twice the value** of its associated Attribute.
...
**Skill & Proficiency Grant (6 Points):**

* **Swords Proficiency:** Level 3 (Body-based; costs 2 points)  
* **Battle:** Level 2 (Heart-based; costs 1 point)  
* **Athletics:** Level 2 (Body-based; costs 1 point)  
* **Awe:** Level 2 (Body-based; costs 1 point)  
* **Shields Proficiency:** Level 2 (Body-based; costs 1 point)  
* *Flexible Points Remaining:* 8 (To be spent by the player)
...
* Offensive: \+1 final damage on attacks; \-1 Defense.  
* Neutral: no bonus or penalty.  
* Defensive: \+1 Defense; \-1 final damage on attacks.  
...
| Name | Class | Damage | Load | Special Rules |
| :---- | :---- | :---- | :---- | :---- |
...
**Thrown/Ranged:** The Fated can make a Ranged attack with this weapon.
